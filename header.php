<!DOCTYPE html>
  ...
  <head>
    ...
    <meta property="og:image" content="<?php echo get_template_directory_uri() ?>/images/kidimat_og.jpg"/>
    <link rel="image_src" href="<?php echo get_template_directory_uri() ?>/images/kidimat_og.jpg" />
      ...
      <div class="container-large">
        <div class="row">
          <div class="mobile-menu">
            <img src="<?php echo get_template_directory_uri() ?>/images/burger-btn.svg" alt="" id="burger-btn">
          </div>
          <a class="logo-icons" href="<?php echo get_site_url(); ?>">
            <img class="logo-desktop" src="<?php echo get_template_directory_uri() ?>/images/logo-kidimat.jpg" alt="Theme logo">
            <img class="logo-mobile w-100" src="<?php echo get_template_directory_uri() ?>/images/logo-mobile.png" alt="Theme logo">
          </a>
