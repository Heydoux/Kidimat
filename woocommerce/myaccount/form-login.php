...
<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) : ?>
    ...
    <div class="tab-bar mt-d ml-1">
      <button class="tab-bar-item is-active button" id="retail" name="retailBtn">Particulier</button>
    ...
    <div id="tab-container" class="retail">
      ...
      <form method="post" class="woocommerce-form woocommerce-form-register register my-0" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
        ...
        <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide d-none">
          <label for="reg_role"><?php _e( 'Professionel', 'woocommerce' ); ?><span class="required">*</span></label>
          <input type="text" class="input-text" name="role" id="reg_role" value="customer" />
        </p>
