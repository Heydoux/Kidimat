<?php
/**
 * Product Categories Widget Kidimat
 *
...
/**
 * Product categories kidimat widget class.
 *
 * @extends WC_Widget
 */
class WC_Widget_Product_Categories_Kidimat extends WC_Widget {
	...
	public function __construct() {
		$this->widget_cssclass    = 'woocommerce widget_product_categories_kidimat';
		$this->widget_description = __( 'A list or dropdown of product categories.', 'woocommerce' );
		$this->widget_id          = 'woocommerce_product_categories_kidimat';
		$this->widget_name        = __( 'Product Categories Kidimat', 'woocommerce' );
		$this->settings           = array(
			'title'              => array(
				'type'  => 'text',
				'std'   => __( 'Product categories Kidimat', 'woocommerce' ),
	...
	public function widget( $args, $instance ) {
      ...
      echo '<li class="cat-item cat-item-all"><a href="' .  get_site_url() . '/le-catalogue">Toutes les catégories</a></li>';
